...
/**
 * intersectionWith - возвращает массив значений из первого массива,
 * которые присутствует во втором массиве
 * _.intersectionWith([{'x':1, 'y':2}, {'x':2, 'y':1}], [{'x':1, 'y':2}], _.isEqual) -> [ { x: 1, y: 2 } ]
 */
